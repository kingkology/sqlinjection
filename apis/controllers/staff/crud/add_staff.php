<?php
  ...
  if (!((isset($_SESSION['hr_portal'])  AND $_SESSION['hr_portal']=="Yes") AND ($_SESSION['app_code']=="UO" OR $_SESSION['app_code']=="SUH" OR $_SESSION['app_code']=="UH" OR $_SESSION['app_code']=="DHOD" OR $_SESSION['app_code']=="HOD" OR $_SESSION['app_code']=="SUPA") )) 
  {
    ...
    {
        $response->send_response(400,"Unable to add staff. staff NID is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff ID is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff TITLE is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff SURNAME is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Forenames is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Date Of Birth is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Gender is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Marital Status is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Nationality is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Disability is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Email is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Contact is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Office is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Grade is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Department is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Department Role is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Unit is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Unit Role is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff SSNIT is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Tin is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Payment method is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Bank Account Number is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Bank Account Name is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Bank Name is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Bank Branch is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Bank District is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Bank Region is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Mobile money number is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Name on Number is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Mother's name is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff Father's name is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Next of Kin Title is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Next of Kin Surname is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Next of Kin Forename is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Next of Kin Contact is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff.  Relation to Next of Kin is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Next of Kin Address is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Next of Kin Postal is required.",NULL);
        return;
    }*/
    ...
    {
        $response->send_response(400,"Unable to add staff. Next of Kin Ghana card is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Emergency Contact Title is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Emergency Contact Surname is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Emergency Contact Forename is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Emergency Contact Number is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Relation to Emergency Contact is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Emergency Contact Address is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. Emergency Contact Postal Address is required.",NULL);
        return;
    }*/
    ...
    {
        $response->send_response(400,"Unable to add staff. Emergency Contact Ghana Card is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff date joined is required.",NULL);
        return;
    }
    ...
    {
        $response->send_response(400,"Unable to add staff. staff appointment type is required.",NULL);
        return;
    }
    ...
    $staff->NEXT_OF_KIN_ADDRESS=$staff_nextofkin_address;
    ...
    $staff->EMERGENCY_ADDRESS=$staff_emergency_address;
    //$staff->EMERGENCY_POSTAL=$staff_emergency_postal;
    $staff->EMERGENCY_NID=strtoupper($staff_emergency_nid);

    $staff->LOGIN_PASSWORD=password_hash( substr($pin, 4,3)."@".strtolower($staff_surname), PASSWORD_DEFAULT);
    ...
    if ($count>0) 
    {
      $response->send_response(400,"staff NID already exists",NULL);
      return;
    }
    ...
    if ($count>0) 
    {
      $response->send_response(400,"staff ID already exists",NULL);
      return;
    }
    ...
    $result = $staff->add_new_staff($hr_con);
    if ($result=="Success") 
    {
        $result =$staff->add_new_login($sys_con);
        if ($result=="Success") 
        {
            $result =$staff->add_staff_bank($hr_con);
            if ($result=="Success") 
            {
                $result =$staff->add_staff_department($hr_con);
                if ($result=="Success") 
                {
                    $result =$staff->add_staff_unit($hr_con);
                    if ($result=="Success") 
                    {
                        $result =$staff->add_staff_mobile_money($hr_con);
                        if ($result=="Success") 
                        {
                            $result =$staff->add_staff_family($hr_con);
                            if ($result=="Success") 
                            {
                                $error_ocured="No";
                            }
    ...
    if($error_ocured=="No")
    {
      ...
      $logs->ACTION= "Add staff";
      $logs->STATEMENT= "Added staff : ".$staff->FULLNAME."(".$staff->PIN.")";
      $logs->DATE= $ladate;
      $logs->TIME= $latimez;
      $logs->add($hr_con);
         

      $response->send_response(201,"staff Added Successfully",NULL);
      $hr_con->commit();
      $sys_con->commit();
      return;
    } 
    ...
    {
      $response->send_response(503,"Error Adding staff -> ",NULL);
      return;
    }
