...
{
	$filter_field=$land->DISTRICT;
}

if (strtolower($filter_field)=="region") 
{
	$filter_field=$land->REGION;
}


$land->QUERY_FIELD=str_replace(" ", "_", strtolower($filter_field));
$land->QUERY_TYPE=$the_type;
$land->QUERY_VALUE=$filter_value;



$result=$land->search_property_region($app_con);
