        ...
        ?>
          ...
          <div class="col-sm-12 col-md-2 col-l-2 col-xl-2 ">
            ...
            <div class="position-relative form-group">
                ...
                <br>
                <button onclick="call_pagelet('../apis/controllers/property_data/tables/load_offices_region.php?start=0&limit=300','mytable');" type="button" class="btn btn-danger" id="tabulator-html-filter-reset">Load All</button>
        ...
        ?>
          ...
          <div class="col-sm-12 col-md-2 col-l-2 col-xl-2 ">
            ...
            <div class="position-relative form-group">
                <label style="color:white;">Search</label>
                <br>
                <button type="button" class="btn btn-warning" id="tabulator-html-filter-go" onclick="call_pagelet('../apis/controllers/property_data/tables/search_residence_region.php?start=0&limit=300&property_type='+property_type.value+'&filter_field='+filter_field.value+'&filter_type='+filter_type.value+'&filter_value='+filter_value.value,'mytable');"><i class="fa fa-search"></i></button>
          ...
          <div class="col-sm-12 col-md-2 col-l-2 col-xl-2 ">
            ...
            <div class="position-relative form-group">
                ...
                <button onclick="call_pagelet('../apis/controllers/property_data/tables/load_residence_region.php?start=0&limit=300','mytable');" type="button" class="btn btn-danger" id="tabulator-html-filter-reset">Load All</button>
        ...
        ?>
          ...
          <div class="col-sm-12 col-md-2 col-l-2 col-xl-2 ">
            ...
            <div class="position-relative form-group">
                <label style="color:white;">Search</label>
                <br>
                <button type="button" class="btn btn-warning" id="tabulator-html-filter-go" onclick="call_pagelet('../apis/controllers/property_data/tables/search_land_region.php?start=0&limit=300&property_type='+property_type.value+'&filter_field='+filter_field.value+'&filter_type='+filter_type.value+'&filter_value='+filter_value.value,'mytable');"><i class="fa fa-search"></i></button>
          ...
          <div class="col-sm-12 col-md-2 col-l-2 col-xl-2 ">
            ...
            <div class="position-relative form-group">
                ...
                <button onclick="call_pagelet('../apis/controllers/property_data/tables/load_land_region.php?start=0&limit=300','mytable');" type="button" class="btn btn-danger" id="tabulator-html-filter-reset">Load All</button>
