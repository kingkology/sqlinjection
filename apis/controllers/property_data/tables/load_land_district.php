...
if (!((isset($_SESSION['user_id'])  AND ($_SESSION['user_type']=="Superadministrator" OR $_SESSION['user_type']=="Administrator" OR $_SESSION['user_type']=="District Supervisor" OR $_SESSION['user_type']=="Data Entry Officer" ) ) )) 
{
	?>
...
$land->REGION=$_SESSION['user_region'];
$land->DISTRICT=$_SESSION['user_district'];

$result=$land->get_all_property_district($app_con);
...
?>
	...
	<thead>
		...
		<tr>
	        ...
	        <th class="col_ls border border-b-2 dark:border-dark-5 whitespace-no-wrap">Land Size</th>
	        <th class="col_puse border border-b-2 dark:border-dark-5 whitespace-no-wrap">Proposed Use</th>
...
<?php
	...
	while($row = $result->fetch_assoc()) 
	{
		...
		<td style="width:100px" class='col_ls'><?php echo $row['land_size']; ?></td>
		<td style="width:100px" class='col_puse'><?php echo $row['proposed_use']; ?></td>
